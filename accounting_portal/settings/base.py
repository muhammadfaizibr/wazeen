...
WSGI_APPLICATION = 'accounting_portal.wsgi.application'
ASGI_APPLICATION = 'accounting_portal.asgi.application'
...
CELERY_TASK_ROUTES = {
    'apps.file_management.tasks.generate_file_preview': {'queue': 'file_processing'},
}
...
SECURE_FILE_ROOT = os.path.join(BASE_DIR, 'secure_files')
